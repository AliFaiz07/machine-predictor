...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "mp/sensors/test/integration/FirstJourney",
    "mp/sensors/test/integration/SensorReadingsListJourney",
    "mp/sensors/test/integration/SensorReadingsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
