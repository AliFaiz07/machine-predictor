...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "mp/alerts/test/integration/FirstJourney",
    "mp/alerts/test/integration/MaintenanceAlertsListJourney",
    "mp/alerts/test/integration/MaintenanceAlertsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
